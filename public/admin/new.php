...
<form action="new.php" method="post">
    <div class="form-group">
        ...
        <input type="text" value="<?php echo htmlspecialchars($terrain['nom_terrain']);?>" class="form-control form-control-sm" id="nom_terrain" name="nom_terrain" placeholder="Entrer le nom du terrain">
    </div>
    <div class="form-group">
        <label for="taille">Taille</label>
        <input type="text" value="<?php echo htmlspecialchars($terrain['taille']);?>" class="form-control form-control-sm" id="taille" name="taille" placeholder="Entrer la taille du terrain ex: 30x40">
    </div>
    <div class="form-group">
        <label for="description">Description</label>
        <textarea name="description" class="form-control form-control-sm" id="description" cols="30" rows="10" placeholder="Entrer la description du terrain"><?php echo htmlspecialchars($terrain['description']);?></textarea>
    </div>
    <div class="form-group">
