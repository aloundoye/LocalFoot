...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Local Foot <?php echo date('Y')?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- Page level plugins -->
<script src="<?php echo  url_for('/admin/vendor/datatables/jquery.dataTables.min.js');?>"></script>
<script src="<?php echo url_for('/admin/vendor/datatables/dataTables.bootstrap4.min.js')?>"></script>

<!-- Page level custom scripts -->
<script src="<?php echo url_for('/js/demo/datatables-demo.js')?>"></script>
